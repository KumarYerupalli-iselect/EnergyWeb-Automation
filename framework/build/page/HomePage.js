...
exports.homePage = {
     ...
     */
    validateOurPartnersHeaderDisplayed(browser) {
     ...
     * @param browser NightWatch Browser
     */
    validateViewOurPartnersBtnDisplayed(browser) {
     ...
     * @param browser NightWatch Browser
     */
    clickOnViewOurPartnersBtn(browser) {
     ...
     * @param browser NightWatch Browser
     */
    validateOurPartnersPage(browser) {
     ...
     * @param browser NightWatch Browser
     */
    validateHealthPartnersLogosDisplayed(browser) {
     ...
     * @param browser NightWatch Browser
     */
    validateEnergyPartnersLogosDisplayed(browser) {
     ...
     * @param browser NightWatch Browser
     */
    validateInternetPartnersLogosDisplayed(browser) {
    ...
    clickOnAddressOption(browser) {
        ...
        helperUtils_1.helperUtils.moveToElement(browser, '//div[text()="' + data.CommonData.Address + '"]', 'Hovering to DropDown Option')
            .click('//div[text()="' + data.CommonData.Address + '"]')
            .useXpath().click(this.elements.startBtn);
        var text = browser.useXpath().getValue(this.elements.energyAddressBar);
    },
    /**
     ...
     */
    validateYourUsagePage(browser, yourUsagePageTitle) {
     ...
     * @param browser NightWatch Browser
     */
    clickOniSelectIconinYourUsagePage(browser) {
     ...
     */
    validateIselectWordPressPage(browser, iSelectWordPressURL, iSelectWordPressTitle) {
     ...
     * @param browser NightWatch Browser
     */
    validateYouMightBeInterestHeader(browser) {
     ...
     */
    validateLinksPresentInYouMightBeInterSection(browser, solarEnergyTitle, switchingElecAndGasTitle, electricityPanTitle, gtidConnectTitle, saveEnergyTitle) {
        helperUtils_1.helperUtils.moveToElement(browser, this.elements.solarBasicLink, 'Hovering to You Might Be Interested in.. Section');
        browser.pause(5000);
        helperUtils_1.helperUtils.click(browser, this.elements.solarBasicLink, 'The Solar Energy Basics Link is Present and Clicking on the link.');
        ...
        browser.assert.title(solarEnergyTitle, 'The Solar Energy Basics Page Title Matches.')
            .back();
        helperUtils_1.helperUtils.moveToElement(browser, this.elements.switchingElecAndGasLink, 'Hovering to Switching Electricity and Gas Link');
        browser.pause(5000);
        helperUtils_1.helperUtils.click(browser, this.elements.switchingElecAndGasLink, 'Switching Electricity and Gas Link is Present and Clicking on the link');
        ...
        browser.assert.title(switchingElecAndGasTitle, 'Switching Electricity and Gas Page Title Matches')
            .back();
        helperUtils_1.helperUtils.moveToElement(browser, this.elements.electricityPlanLink, 'Hovering to How to find the Electricity Plan that suits you Link');
        browser.pause(5000);
        helperUtils_1.helperUtils.click(browser, this.elements.electricityPlanLink, 'How to find the Electricity Plan that suits you Link is Present and Clicking on the link');
        ...
        browser.assert.title(electricityPanTitle, 'How to find the Electricity Plan that suits you Page Title Matches')
            .back();
        helperUtils_1.helperUtils.moveToElement(browser, this.elements.gridConnectLink, 'Hovering to Grid Connect and Off-Grid Link');
        browser.pause(5000);
        helperUtils_1.helperUtils.click(browser, this.elements.gridConnectLink, 'Grid Connect and Off-Grid Link is Present and Clicking on the link');
        ...
        browser.assert.title(gtidConnectTitle, 'Grid Connect and Off-Grid Page Title Matches')
            .back();
        helperUtils_1.helperUtils.click(browser, this.elements.nextBtnInYurUsageSection, 'Clicking on Next Button');
        browser.pause(5000);
        helperUtils_1.helperUtils.click(browser, this.elements.saveEnergyLink, 'How to Save Energy Link is Present and Clicking on the link');
     ...
     * @param browser NightWatch Browser
     */
    validateCallUsToolTip(browser) {
        helperUtils_1.helperUtils.moveToElement(browser, this.elements.phoneUsElement, 'Call Us Elemenet is visible and Hovering on to it.');
     ...
     * @param browser NightWatch Browser
     */
    moveToBottomofPage(browser) {
        helperUtils_1.helperUtils.moveToElement(browser, this.elements.energyFooter, 'Scrolled down to Bottom of the Page');
    },
    /**
     * Click and Validates the Compare Electricity and Gas Button
     * @param browser NightWatch Browser
     */
    clickAndValidateCompElecandGasBtn(browser) {
        helperUtils_1.helperUtils.click(browser, this.elements.compElecAndGasSideBtn, 'Clicking on "Compare Electricity and Gas" Right Side Button');
        browser.pause(3000);
     ...
     * @param browser NightWatch Browser
     */
    validateSocialMediaLinks(browser) {
     ...
     */
    validateAboutIselectLinks(browser, aboutIselectLink, multiple) {
        if (multiple == true) {
     ...
     */
    validate2019PartnerAwardsLinks(browser, partnerawardslink) {
