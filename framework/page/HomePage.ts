...
export const homePage = {
   ...
   * @param browser NightWatch Browser
   */
  clickOnAddressOption(browser: NightwatchBrowser) {
    ...
    helperUtils.moveToElement(browser, '//div[text()="'+ data.CommonData.Address +'"]', 'Hovering to DropDown Option')
  ...
  validateLinksPresentInYouMightBeInterSection(browser:NightwatchBrowser, solarEnergyTitle : string, switchingElecAndGasTitle : string, electricityPanTitle : string, gtidConnectTitle : string, saveEnergyTitle : string) {
    ...
    browser.pause(5000);
    helperUtils.click(browser, this.elements.solarBasicLink, 'The Solar Energy Basics Link is Present and Clicking on the link.');
    ...
    browser.pause(5000);
    helperUtils.click(browser, this.elements.switchingElecAndGasLink, 'Switching Electricity and Gas Link is Present and Clicking on the link');
    ...
    browser.pause(5000);
    helperUtils.click(browser, this.elements.electricityPlanLink, 'How to find the Electricity Plan that suits you Link is Present and Clicking on the link');
    ...
    browser.pause(5000);
    helperUtils.click(browser, this.elements.gridConnectLink, 'Grid Connect and Off-Grid Link is Present and Clicking on the link');
    ...
    helperUtils.click(browser, this.elements.nextBtnInYurUsageSection, 'Clicking on Next Button');
    browser.pause(5000);
    helperUtils.click(browser, this.elements.saveEnergyLink, 'How to Save Energy Link is Present and Clicking on the link');
  ...
  clickAndValidateCompElecandGasBtn(browser:NightwatchBrowser) {
    helperUtils.click(browser, this.elements.compElecAndGasSideBtn, 'Clicking on "Compare Electricity and Gas" Right Side Button');
    browser.pause(3000);
